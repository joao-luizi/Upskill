...
CREATE PROCEDURE Utilizador_CriarPorAdmin
    @UserName NVARCHAR(50) = NULL,
    @PassWord NVARCHAR(50) = NULL,
    @Nome NVARCHAR(50),
    @Email    NVARCHAR(255) = NULL,
...
CREATE PROCEDURE Utilizador_CriarPorLeitor
...
BEGIN
	/*
	PARTE III 1. Fazer o registo de leitor
	*/
    SET NOCOUNT ON;
	DECLARE @ID_Utilizador BIGINT
...
CREATE OR ALTER PROCEDURE Utilizador_Cancelar
@ID_Utilizador BIGINT
AS
BEGIN
...
CREATE PROCEDURE Disponibilidade_Exemplares_NucleoAssunto 	
AS
BEGIN
	SET NOCOUNT ON;
...
CREATE PROCEDURE Disponibilidade_Exemplares_Assunto 
AS
BEGIN
	SET NOCOUNT ON;
    -- Grouped by Assunto
...
CREATE PROCEDURE Disponibilidade_Exemplares_Nucleo	
AS
BEGIN
	SET NOCOUNT ON;
    -- Grouped by Núcleo
...
CREATE PROCEDURE Disponibilidade_Exemplares_Geral	
AS
BEGIN
	SET NOCOUNT ON;
    -------------------------------------------------------------------
